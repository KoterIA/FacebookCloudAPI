...
from facebookcloudapi.api.dto import (MessageObject, ContactObject)
...
class APIAbstract:
    ...
    def send_message_object(self, from_number_id: str, message_object: MessageObject, object_data: TextObject,
